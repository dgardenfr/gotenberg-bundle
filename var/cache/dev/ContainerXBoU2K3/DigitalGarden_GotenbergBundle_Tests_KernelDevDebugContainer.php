 ...
 */
class DigitalGarden_GotenbergBundle_Tests_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->aliases = [
            'DigitalGarden\\GotenbergBundle\\Tests\\Kernel' => 'kernel',
        ];
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $a->allowControllers(['DigitalGarden\\GotenbergBundle\\Tests\\Kernel']);
    ...
    private function getDynamicParameter(string $name)
    {
        ...
        $value = match ($name) {
            ...
            'debug.container.dump' => ($container->targetDir.''.'/DigitalGarden_GotenbergBundle_Tests_KernelDevDebugContainer.xml'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'DigitalGarden_GotenbergBundle_Tests_KernelDevDebugContainer',
